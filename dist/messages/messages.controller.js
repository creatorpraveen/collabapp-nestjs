...
let MessagesController = class MessagesController {
    ...
    async getCollaborationMessages(collaborationId, req) {
        return this.messagesService.findByCollaborationId(collaborationId, req.user.sub);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MessagesController.prototype, "getCollaborationMessages", null);
